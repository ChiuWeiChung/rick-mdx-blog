...
interface SmartFormProps<TFieldValues extends FieldValues = FieldValues> extends UseFormReturn<TFieldValues> {
...
export default function SmartForm<TFieldValues extends FieldValues = FieldValues>({ children, onSubmit, onSubmitError, className, ...formProps }: SmartFormProps<TFieldValues>) {

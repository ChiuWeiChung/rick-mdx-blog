  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button variant="outline" role="combobox" className={cn('justify-between', !selectedLabel && 'text-muted-foreground')}>
          ...
          <CommandList>
            ...
            <CommandGroup>
              {options.map((opt) => (
                ...
                >
                  {opt.label}
                  <Check className={cn('ml-auto', opt.value === value ? 'opacity-100' : 'opacity-0')} />
                </CommandItem>
              ))}
            </CommandGroup>
          </CommandList>
